...
A voluntary self-testing skill to verify your understanding of code changes.

## Usage

Invoke with `/code-quiz:quiz` to test yourself on recent code changes.
...
For a function that validates email addresses:
- "What regex pattern is used to validate the email format?"
- "What happens if the email parameter is null?"
- "Why does this function return early on line 15?"

For a React component:
- "What state changes trigger a re-render of this component?"
- "What is the purpose of the useEffect dependency array?"
- "How does this component handle loading states?"

## Notes

- This is a learning tool, not an enforcement mechanism
- Focus on questions that promote genuine understanding
